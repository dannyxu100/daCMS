...
<div>
	<div class="header">
		<span style="margin-right:20px;">产品分类管理</span>
				...
				<div id="pad_config">
					...
					<table id="navform" class="grid" style="width:100%">
						<tr>
							...
							<td><input id="pt_id" type="text" style="width:50px;" disabled="true" value=""/></td>
							<td class="header" style="width:80px;">排序</td>
							<td><input id="pt_sort" type="text" style="width:50px;" value=""/></td>
						</tr>
						<tr>
							<td class="header" style="width:80px;">分类名称</td>
							<td style="width:160px;"><input id="pt_name" type="text" style="width:200px;" value="" /></td>
							<td class="header" style="width:80px;">列表条数</td>
							<td><input id="pt_listnum" type="text" style="width:50px;" value="10"/></td>
						</tr>
						<tr>
							<td class="header" style="width:80px;">列表风格</td>
							<td colspan="3">
								<label title="单页面" style="margin-right:10px;">
									<input type="radio" name="pro_style" value="SINGLEPAGE" onclick="showstylepad(this)"/>
									<img src="/images/style_single.gif" style="vertical-align:middle;"/>
								</label>
								<label title="列表" style="margin-right:10px;">
									<input type="radio" name="pro_style" value="LIST" checked="true" onclick="showstylepad(this)"/>
									<img src="/images/style_list.gif" style="vertical-align:middle;"/>
								</label>
								<label title="略缩图" style="margin-right:10px;">
									<input type="radio" name="pro_style" value="ICONLIST" onclick="showstylepad(this)"/>
									<img src="/images/style_iconlist.gif" style="vertical-align:middle;"/>
								</label>
								<label title="九宫格" style="margin-right:10px;">
									<input type="radio" name="pro_style" value="ICON" onclick="showstylepad(this)"/>
									<img src="/images/style_icon.gif" style="vertical-align:middle;"/>
								</label>
								<label title="超链接" style="margin-right:5px;">
									<input type="radio" name="pro_style" value="LINK" onclick="showstylepad(this)"/>
									<img src="/images/style_link.gif" style="vertical-align:middle;"/>
								</label>
								<label title="自定义" style="margin-right:10px;">
									<input type="radio" name="pro_style" value="USERDEFINED" onclick="showstylepad(this)"/>
						...
						<tr id="SINGLEPAGE_pad" style="display:none;">
							...
							<td colspan="3">
								<textarea id="pt_content" style="width:700px;height:600px;"></textarea>
							</td>
						</tr>
						<tr id="LINK_pad" style="display:none;">
							<td class="header">超链接</td>
							<td colspan="3">
								<input id="pt_url" type="text" style="width:320px;" value=""/>
							</td>
						</tr>
						<tr>
							<td class="header">略缩图</td>
							<td colspan="3">
								<input id="pt_img" type="text" style="width:320px;" value=""/>
						...
						<tr>
							<td class="header">&nbsp;</td>
							<td colspan="3">
								<img id="pt_img_view" src="/images/no_img.gif" style="height:80px; border:1px solid #f0f0f0"/>
							</td>
						</tr>
						<tr>
							<td class="header">SEO关键字</td>
							<td colspan="3">
								<textarea id="pt_keywords" style="width:400px;height:100px;"></textarea>
						...
						<tr>
							...
							<td colspan="3">
								<textarea id="pt_description" style="width:400px;height:100px;"></textarea>
								<br/><span style="color:#900">注: 如果不设置，将以"网站配置"->"SEO描述"为准。</span>
							</td>
						</tr>
						<tr>
							<td class="header">备注</td>
							<td colspan="3"><textarea id="pt_remark" style="width:400px;height:100px;"></textarea></td>
						</tr>
					</table>
				</div>
...
<script type="text/javascript" src="js/producttype_manage.js"></script>
