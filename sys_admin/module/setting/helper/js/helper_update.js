...
function updatehelper(){
	...
	da.runDB("/sys_admin/module/setting/helper/action/helper_update_item.php",{
		hid: g_hid,
		hname: da("#h_name").val(),
		hcode: da("#h_code").val(),
		hsort: da("#h_sort").val(),
...
*/
function loadinfo(){
	da.runDB("/sys_admin/module/setting/helper/action/helper_get_item.php",{
		dataType: "json",
		hid: g_hid
	...
	KindEditor.ready(function(K) {
		g_editor = K.create('#h_content', {
			extraFileUploadParams : {
				folder: "/sys_admin/module/setting/helper/"
			},
			resizeType: 1,
