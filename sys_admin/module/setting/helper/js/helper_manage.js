...
function beforeRemove(treeId, treeNode) {
	...
	function(){
		da.runDB("/sys_admin/module/setting/helper/action/helpertype_get_list.php",{			//检查是否拥有下级部门
			htpid: treeNode.id
		},
		function(res){debugger;
			if('FALSE'==res){
				da.runDB("/sys_admin/module/setting/helper/action/helpertype_delete_item.php",{
				 htid: treeNode.id
				},
				function(res){
					if("FALSE"==res){
...
function beforeRename(treeId, treeNode, newName) {
	if (newName.length == 0) {
		...
		da.runDB("/sys_admin/module/setting/helper/action/helpertype_update_item.php",{
			htid: treeNode.id,
			htname: newName
		},
		function(res){
...
function addHoverDom(treeId, treeNode) {
	...
	if (btn) btn.bind("click", function(){
		...
		da.runDB("/sys_admin/module/setting/helper/action/helpertype_add_item.php",{
			htpid: treeNode.id,
			name: "新建分类"
		},
		function(res){
...
function addhelper(){
	...
	goto("/sys_admin/module/setting/helper/helper_add.php?htid="+ g_htid);
	// daWin({
		// width: 850,
		// height: 600,
		// url: "/sys_admin/module/setting/helper/helper_add.php?htid="+ g_htid,
		// title: "新添加帮助文档",
		// after: function(){
			// loadlist();
		// }
...
function deletehelper(){
	...
	if( hids ){
		confirm("确认删除选中的文档吗？",function(){
			da.runDB("/sys_admin/module/setting/helper/action/helper_delete_list.php",{
				htid: g_htid,
				hids: hids.join(",")
			},function(res){
				if("FALSE" == res){
...
function updatehelper(hid){
	goto("/sys_admin/module/setting/helper/helper_update.php?hid="+ hid);
	// daWin({
		// width: 850,
		// height: 600,
		// url: "/sys_admin/module/setting/helper/helper_update.php?hid="+ hid,
		// title: "修改帮助文档"
	// });
}
...
function viewhelper(hid){
	daWin({
		width: 850,
		height: 600,
		url: "/sys_admin/module/setting/helper/helper_view.php?hid="+ hid,
		title: "查看帮助文档"
	});
}
...
function loadlist(){
	daTable({
		id: "tb_list",
		url: "/sys_admin/module/setting/helper/action/helper_get_page.php",
		data: {
			dataType: "json",
			// opt: "qry",
			htid: g_htid
...
*/
function loadinfo(){
	da.runDB("/sys_admin/module/setting/helper/action/helpertype_get_item.php",{
		dataType: "json",
		htid: g_htid
	},
	function(res){
...
/*加载左边部门数据*/
function loadtree(){
	da.runDB("/sys_admin/module/setting/helper/action/helpertype_get_list.php",{
		dataType: "json",
	},
	function(data){
		var zNodes = [];
