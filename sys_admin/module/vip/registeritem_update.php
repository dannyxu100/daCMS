		...
		<tr>
			<td style="vertical-align:top;">
				<div class="list_top_bar">
					<div class="list_top_title">修改注册项</div>
				...
				<table class="grid" style="width:100%;">
					...
					<tr>
						...
						<td>
							<input id="vr_sort" type="text" style="width:50px;" value="999" valid="int" validinfo="只能是整数"/>
						</td>
					</tr>
					<tr>
...
<script type="text/javascript" src="js/registeritem_update.js"></script>
