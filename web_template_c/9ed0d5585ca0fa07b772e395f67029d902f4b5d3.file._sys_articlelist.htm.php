...
?>
		<div style="margin:10px 0px;">
			...
			<a href="<?php echo fn_urlstatic(array('url'=>('articledetail.php?aid=').($_smarty_tpl->tpl_vars['articleset']->value[$_smarty_tpl->getVariable('smarty')->value['section']['list']['index']]['a_id'])),$_smarty_tpl);?>
">
